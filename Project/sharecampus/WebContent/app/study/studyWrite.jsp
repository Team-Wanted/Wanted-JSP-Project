			...
			<div class="section">
				...
				<div class="group area">
					<label class="checkbox"><input type="radio"
						name="studyArea" value="KR01">서울특별시</label> <label
						class="checkbox"><input type="radio" name="activArea"
						value="KR02">경기도</label> <label class="checkbox"><input
						type="radio" name="activArea" value="KR03">부산광역시</label> <label
						class="checkbox"><input type="radio" name="activArea"
						value="KR04">인천광역시</label> <label class="checkbox"><input
						type="radio" name="activArea" value="KR05">대구광역시</label> <label
						class="checkbox"><input type="radio" name="activArea"
						value="KR06">경상남도</label> <label class="checkbox"><input
						type="radio" name="activArea" value="KR07">경상북도</label> <label
						class="checkbox"><input type="radio" name="activArea"
						value="KR08">대전광역시</label> <label class="checkbox"><input
						type="radio" name="activArea" value="KR09">충청남도</label> <label
						class="checkbox"><input type="radio" name="activArea"
						value="KR10">충청북도</label> <label class="checkbox"><input
						type="radio" name="activArea" value="KR11">전라남도</label> <label
						class="checkbox"><input type="radio" name="activArea"
						value="KR12">전라북도</label> <label class="checkbox"><input
						type="radio" name="activArea" value="KR13">광주광역시</label> <label
						class="checkbox"><input type="radio" name="activArea"
						value="KR14">강원도</label> <label class="checkbox"><input
						type="radio" name="activArea" value="KR15">울산광역시</label> <label
						class="checkbox"><input type="radio" name="activArea"
						value="KR16">제주특별자치도</label> <label class="checkbox"><input
						type="radio" name="activArea" value="KR17">세종특별자치시</label> <label
						class="checkbox"><input type="radio" name="activArea"
						value="KR00">기타</label>
				</div>
